...
<div class="card mb-20" style="padding:40px 32px;text-align:center;background:linear-gradient(135deg,var(--primary),#7c3aed);color:#fff;border:none">
  <div style="font-size:48px;margin-bottom:12px"><i data-lucide="graduation-cap" class="lucide"></i></div>
...
<div class="col-main">
  ...
  <div class="card mb-20">
    <div class="card-header"><i data-lucide="book-open" class="lucide"></i> 项目简介</div>
  ...
  <!-- 功能特色 -->
  <div class="card mb-20">
    <div class="card-header"><i data-lucide="sparkles" class="lucide"></i> 功能特色</div>
    <div class="card-body">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px">
        <?php
        $features = [
            ['<i data-lucide="building-2" class="lucide"></i>','四大分区','学术/校园/职业/技术，16个子板块精细分类'],
            ['<i data-lucide="bot" class="lucide"></i>','AI 赋能','摘要生成、个性推荐、AI助手、内容质检'],
            ['<i data-lucide="home" class="lucide"></i>','社团系统','申请建团、招募成员、动态发布、角色管理'],
            ['<i data-lucide="message-circle" class="lucide"></i>','私信系统','私聊与群组、消息撤回、未读徽章、实时轮询'],
            ['<i data-lucide="flag" class="lucide"></i>','举报机制','多类型举报、管理员审核、一键封禁/删帖'],
            ['<i data-lucide="headphones" class="lucide"></i>','客服中心','AI客服优先、无法解决可转人工工单'],
            ['<i data-lucide="moon" class="lucide"></i>','深色主题','Light/Dark 一键切换，localStorage 持久化'],
            ['<i data-lucide="building" class="lucide"></i>','本校模式','按学校筛选帖子，促进同校学生交流'],
        ];
  ...
  <!-- 技术架构 -->
  <div class="card">
    <div class="card-header"><i data-lucide="settings" class="lucide"></i> 技术架构</div>
    <div class="card-body">
...
<div class="col-side">
  ...
  <div class="card mb-16">
    <div class="card-header"><i data-lucide="bar-chart-2" class="lucide"></i> 平台数据</div>
    <div class="card-body">
      <?php
      ...
      $stats = [['<i data-lucide="file-text" class="lucide"></i>',$post_cnt,'帖子总数'],['<i data-lucide="users" class="lucide"></i>',$user_cnt,'注册用户'],['<i data-lucide="message-circle" class="lucide"></i>',$comm_cnt,'评论总数'],['<i data-lucide="home" class="lucide"></i>',$club_cnt,'活跃社团']];
      foreach ($stats as $s): ?>
  ...
  <div class="card">
    <div class="card-header"><i data-lucide="link-2" class="lucide"></i> 快速入口</div>
    <div class="card-body" style="display:flex;flex-direction:column;gap:8px">
      <a href="../index.php" class="btn btn-primary" style="text-align:center"><i data-lucide="home" class="lucide"></i> 进入首页</a>
      <a href="support.php"  class="btn btn-outline" style="text-align:center"><i data-lucide="headphones" class="lucide"></i> 联系客服</a>
    </div>
  </div>
